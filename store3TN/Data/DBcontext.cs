...
namespace store3TN.Data
{
    public class DBContext
    {
        ...
        {
            SqlConnection conn = openConnection();
            // select limit 9 * from SanPham where Hot = 1 order by MaSP desc
        ...
        {
            SqlConnection conn = openConnection();
            // count number of SanPham in table SanPham where MaLSP = 1
        ...
        {
            SqlConnection conn = openConnection();
            // count number of SanPham in table SanPham where RAM = 4GB
